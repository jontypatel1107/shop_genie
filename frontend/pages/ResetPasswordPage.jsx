...
import { ArrowLeft, ArrowRight, BadgeCheck, HelpCircle, KeyRound, LifeBuoy, Mail, Loader2 } from "lucide-react";
              ...
              <div className="relative flex items-center justify-center px-5 py-8 sm:px-10 lg:px-14">
                ...
                <form className="relative w-full max-w-[450px]" onSubmit={handleSubmit}>
                  ...
                  <button
                    ...
                    type="submit"
                  >
                    {loading ? <Loader2 className="h-5 w-5 animate-spin" /> : (sent ? "Resend Link" : "Reset Password")}
                    {!loading && !sent && <ArrowRight className="h-5 w-5" />}
                  </button>
