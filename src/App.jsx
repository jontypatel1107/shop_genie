...
import { ArrowRight, CheckCircle2, Info, PackagePlus, ShoppingBag, Sparkles } from "lucide-react";
...
export default function App() {
  return (
    <main className="h-[100dvh] overflow-hidden bg-[#161616] text-slate-900">
      <section className="grid h-full overflow-hidden bg-[#f6f4ee] lg:grid-cols-[0.98fr_1fr]">
        <div className="flex flex-col justify-between px-7 py-5 sm:px-10 sm:py-7 lg:px-14 lg:py-8">
          <div>
            <div className="mb-8 inline-flex items-center gap-3">
              <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-[#0f7c72] text-white shadow-lg shadow-[#0f7c72]/20">
            ...
            <div className="max-w-xl">
              <h1 className="text-[2.6rem] leading-[0.92] font-extrabold tracking-[-0.06em] text-[#252933] sm:text-[3.8rem] lg:text-[4.35rem]">
                Your craft
                <br />
                deserves a
                <br />
              ...
              <div className="mt-8 flex flex-wrap items-center gap-4">
                <button className="inline-flex items-center gap-3 rounded-2xl bg-[#0f7c72] px-7 py-4 text-base font-semibold text-white shadow-[0_18px_35px_rgba(15,124,114,0.28)] transition-transform duration-200 hover:-translate-y-0.5">
                  Let&apos;s Get Started
              ...
              <div className="mt-6 flex max-w-md gap-4 rounded-2xl border border-white/70 bg-white/70 p-4 shadow-[0_16px_45px_rgba(17,24,39,0.06)] backdrop-blur">
                ...
                <div>
                  <p className="text-sm font-semibold text-[#26323a]">Digital concierge onboarding</p>
          ...
          <div className="mt-5">
            <div className="flex max-w-md flex-wrap gap-7 sm:gap-12">
              {metrics.map((metric) => (
            ...
            <p className="mt-4 text-sm text-[#7b8088]">
              ...
              <a className="font-bold text-[#0f7c72]" href="/">
                Log in here
              </a>
            </p>
          </div>
        ...
        <div className="relative min-h-[460px] overflow-hidden lg:min-h-0">
          ...
          <div className="absolute bottom-4 right-4 sm:bottom-7 sm:right-7">
            <div className="w-[12rem] rounded-[1.4rem] bg-white/90 p-4 shadow-[0_20px_45px_rgba(15,23,42,0.2)] backdrop-blur-sm">
