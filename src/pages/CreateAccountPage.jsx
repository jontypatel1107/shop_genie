...
export default function CreateAccountPage() {
  ...
  return (
    <main className="min-h-[100dvh] bg-[#f5f6f8] text-slate-900">
      <section className="relative flex min-h-[100dvh] w-full items-center justify-center px-5 py-6 sm:px-8 sm:py-8 lg:px-12">
        <div className="grid w-full max-w-[1320px] gap-8 lg:grid-cols-[1fr_0.95fr] lg:items-center lg:gap-14 xl:min-h-[100dvh] xl:py-8">
          <div className="max-w-[38rem]">
            ...
            <h1 className="mt-8 max-w-[32rem] text-[2.35rem] leading-[1.05] font-extrabold tracking-[-0.07em] text-[#2e3138] sm:mt-10 sm:text-[3.2rem] xl:text-[4rem]">
              Bring your shop to
              <br />
            ...
            <p className="mt-5 max-w-[27rem] text-base leading-7 text-[#666c75] sm:mt-6 sm:text-lg sm:leading-8">
              Designed for artisans, makers, and neighborhood favorites. No technical
              skills required.
            </p>

            <div className="relative mt-8 overflow-hidden rounded-[1.65rem] bg-[#593312] shadow-[0_28px_55px_rgba(30,41,59,0.14)] lg:mt-10">
              ...
              <div className="relative flex min-h-[13rem] items-end p-4 sm:min-h-[16rem] sm:p-5 xl:min-h-[18rem] xl:p-6">
          ...
          <div className="relative">
            <div className="mx-auto max-w-[41rem] rounded-[1.85rem] bg-[#e7eaef] p-5 shadow-[0_20px_60px_rgba(148,163,184,0.22)] sm:p-8 lg:p-10">
              <div className="max-w-[29rem]">
                <h2 className="text-[1.85rem] font-extrabold tracking-[-0.05em] text-[#2d3138] sm:text-[2.15rem]">
                  Create your account
                </h2>
                ...
                <form className="mt-6 space-y-4 sm:mt-8 sm:space-y-5" onSubmit={handleSubmit}>
                  <label className="block">
                    ...
                    <input
                      className="w-full rounded-2xl border border-transparent bg-[#dce1e7] px-4 py-3.5 text-base text-[#32363d] outline-none transition focus:border-[#19756f] focus:bg-white sm:px-5 sm:py-4"
                  ...
                  <button
                    className="inline-flex w-full items-center justify-center gap-2 rounded-2xl bg-[#0f7c72] px-6 py-3.5 text-base font-semibold text-white shadow-[0_18px_32px_rgba(15,124,114,0.28)] transition-transform duration-200 hover:-translate-y-0.5 sm:py-4 sm:text-lg"
                    type="submit"
                  >
                    Create Account
                ...
                <p className="mt-4 text-center text-sm text-[#727881]">
                  No credit card required. No technical skills needed.
                </p>

                <div className="mt-8 flex flex-wrap items-center gap-x-5 gap-y-3 text-sm text-[#6e757e] sm:mt-10 lg:mt-14">
                  <p>
                  ...
                  <a className="hover:text-[#1a6f69]" href={CREATE_ACCOUNT_ROUTE}>
                    Privacy Policy
                  </a>
